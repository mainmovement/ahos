...
| ACI-GAP-010 | No executed AGI/ACI six-baseline suite; P4.1–P4.3 executed a SYNTHETIC cognitive-correctness vector | Cannot claim intelligence improvement or soak calibration | P1 | P1 | `architecture/cognitive/benchmark/`; `P4_3_RETRIEVAL_BENCHMARK_REPORT.md` | Keep measuring; do not fabricate 99.9%; do not auto-tune to pass | PARTIAL | P4_3_LOOKALIKE_MEASURED |
