...
| ACI-GAP-010 | No executed AGI/ACI benchmark suite; P3 has a small SYNTHETIC deterministic suite only | Cannot claim intelligence improvement or soak calibration | P1 | P1 | `COGNITIVE_LOOP_BENCHMARK.md`; BENCHMARK_PLAN.md | Expand after soak; never fabricate 99.9% | PARTIAL | P3_SYNTHETIC_ONLY |
