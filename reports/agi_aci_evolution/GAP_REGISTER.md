...
| ACI-GAP-006 | Domain-general reasoning orchestrator exists isolated; not production/soak wired; causal/CF NOT_IMPLEMENTED | Isolated loop cannot yet use soak evidence | P3/P5 | P3 | `architecture/cognitive/loop/`; `reasoning.py` orchestrator=PARTIAL | Keep isolated; no soak ingest this pass | PARTIAL | LOOP_UNIT_TESTED |
...
| ACI-GAP-010 | No executed AGI/ACI six-baseline suite; P4.1/P4.2 executed a SYNTHETIC cognitive-correctness vector with honest FAILs | Cannot claim intelligence improvement or soak calibration | P1 | P1 | `architecture/cognitive/benchmark/`; `P4_1_COGNITIVE_BENCHMARK_REPORT.md`; `P4_2_RETRIEVAL_BENCHMARK_REPORT.md` | Keep measuring; do not fabricate 99.9%; do not auto-tune to pass | PARTIAL | P4_2_RETRIEVAL_MEASURED |
