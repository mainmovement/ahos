...
|--------|-------------|--------|------------|----------|----------|-------------------|----------------------|-------------------|
| ACI-GAP-001 | No unified provenance-bearing memory (working/episodic/semantic/procedural) | Cannot retrieve/contradict/decay beliefs as a cognitive system | P2 | P2 | No MemoryStore; VersionedClaimStore is claims-only | Typed stores; do not dump unstructured logs | OPEN | UNVALIDATED |
