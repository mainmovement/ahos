...
| 0004 | 2026-09-09 | P3 cognitive retrieval + context + reasoning loop | ACCEPT for isolated PR; soak/Lane A untouched |
...
- `ARCHITECTURE_MAP.md`
- `BENCHMARK_PLAN.md`
- `COGNITIVE_LOOP_AUDIT.md`
- `COGNITIVE_LOOP_IMPLEMENTATION_EVIDENCE.md`
- `COGNITIVE_LOOP_BENCHMARK.md`
- `P4_1_BENCHMARK_AUDIT.md`
- `P4_1_COGNITIVE_BENCHMARK_REPORT.md`
- `p4_1_cognitive_benchmark_latest.json`
- `P4_2_RETRIEVAL_RELEVANCE_AUDIT.md`
- `P4_2_RETRIEVAL_BENCHMARK_REPORT.md`
- `p4_2_retrieval_benchmark_latest.json`
- `p4_2_p41_baseline.json`
- `P4_3_LOOKALIKE_DISCRIMINATION_AUDIT.md`
