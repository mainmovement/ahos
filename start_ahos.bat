...
echo     curl.exe -L -o AHOS_MAIN_CLEAR_G2.cmd https://raw.githubusercontent.com/mainmovement/ahos/ade1bf28a1a26bbbfea7f128d91653696d836b95/AHOS_MAIN_CLEAR_G2.cmd
